...
async function fetchMovieDetails(movieId) {
    ...
    try {
        ...
        const movieFormatted = {
            ...
            duration: movieDetails.runtime, // Ensure runtime is provided, otherwise you might need a fallback or omit
            genre: movieDetails.genre_ids.map(id => genreDeFilm(movieDetails.genres)) // Assuming you have a function to convert genre IDs
        };
